...
public class RedisKeyConstants {
    ...
    public static final String COLUMN_PREFIX = "inkstage:column:";
    public static final String COLUMN_HOT_PREFIX = "inkstage:column:hot:";
    ...
    public static final String CACHE_COLUMN_LIST = "column:list";
    public static final String CACHE_COLUMN_ARTICLES = "column:articles";
    public static final String CACHE_COLUMN_HOT = "column:hot";
    ...
    public static final Duration CACHE_COLUMN_DETAIL_TTL = DEFAULT_TTL;
    public static final Duration CACHE_COLUMN_LIST_TTL = MEDIUM_TTL;
    public static final Duration CACHE_COLUMN_ARTICLES_TTL = MEDIUM_TTL;
    public static final Duration CACHE_COLUMN_HOT_TTL = LONG_TTL;
